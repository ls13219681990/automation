 ...
 */
@Data
public class WorkSpotMeasuringSpotDataPage implements Serializable {
    ...
    public WorkSpotMeasuringSpotDataPage() {
    }

    public WorkSpotMeasuringSpotDataPage(Integer id, String measuringSpotName, String measuringSpotType, String measuringSpotSensorNo, String measuringSpotOriginalValue, Double measuringSpotValue, Double measuringSpotDifference, Double measuringSpotAccumulationValue, String receiveTime, Double dayRateValue, String initial_value) {
        this.id = id;
