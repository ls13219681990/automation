...
@Data
public class MeasuringSpotDataPage {
    /*
...
（测点位置：隧道区间为里程标；车站基坑为分区等等，用户自行录入）
    ...
    public MeasuringSpotDataPage() {
    }

    public MeasuringSpotDataPage(Long id, Long measuringSpotId, String measuringSpotSensorNo, String measuringSpotOriginalValue, Double measuringSpotValue, Double measuringSpotDifference, Double measuringSpotAccumulationValue, String receiveTime, Double dayRateValue, String measurePattern, Byte status) {
        this.id = id;
